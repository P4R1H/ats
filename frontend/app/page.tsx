      ...
      <section className="relative overflow-hidden px-4 pt-20 pb-32">
        ...
        <div className="relative max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            Rise to the{' '}
            <span className="bg-gradient-to-r from-amber-600 to-orange-500 bg-clip-text text-transparent animate-gradient">
              Top
            </span>
            <br />
          ...
          <div className="space-y-12">
            ...
            <div className="flex gap-6 items-start">
              <div className="flex-shrink-0">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-600 to-orange-500 flex items-center justify-center shadow-lg">
                  ...
                  <tr className="border-b border-gray-100 hover:bg-amber-50/30 transition">
                    ...
                    <td className="py-5 px-6 text-center">
                      <div className="flex justify-center">
                        <div className="w-8 h-8 rounded-full bg-gradient-to-r from-amber-600 to-orange-500 flex items-center justify-center">
